...
export const CHAPTER_ONE_LEVELS: readonly CampaignLevel[] = [
  {
    ...
    goal: { kind: "cup", position: { x: 1.2, y: -2.2 }, halfExtents: { x: 0.82, y: 0.76 } },
    bolt: { x: 0.15, y: -0.65 },
    platforms: [
      ...sideWalls,
      { position: { x: -0.45, y: -2.62 }, halfExtents: { x: 3.35, y: 0.16 }, rotation: 0, friction: 0.16, surface: "slick" },
      { position: { x: 1.2, y: -2.85 }, halfExtents: { x: 0.82, y: 0.16 }, rotation: 0, friction: 0.16, surface: "slick" },
      { position: { x: 2.02, y: -2.05 }, halfExtents: { x: 0.12, y: 0.72 }, rotation: 0 },
    ],
  },
  {
    id: 2,
